# https://github.com/karpathy/nanoGPT/blob/93a43d9/model.py
import math
import inspect
...
class GPTConfig:
    ...
    # efficiency (shouldn't page sizes auto-pad?)
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None, mask=None):
        ...
        if targets is not None:
            ...
            # very last position note: using list [-1] to preserve the time dim
    ...
    def crop_block_size(self, block_size):
        ...
        # (block size 1024) but want to use a smaller block size for some
